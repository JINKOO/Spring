...
/*
 *  #. 작성한 코드에서 Class를 변경할 때 수정해야 할 부분이 생긴다.
 *     기존 HelloWorldEn Class를 통하여 객체를 생성하고, HelloWorldEn의 sayHello()를 호출한다.
 *     하지만,
 *     HelloWorldKo라는 Class가 추가되고, HelloWorldKo의 sayHello()를 호출하기 위해서는
